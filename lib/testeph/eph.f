...
C
      ...
      DIMENSION SS(3),CVAL(400),PVSUN(6),zips(2),PNUT(4)  !qzx 2016-10-31 add PNUT(4)
      data zips/2*0.d0/
...
C
      ...
      INTEGER IPT(3,13),DENUM,list(12) !qzx 2016-10-31 list(11) to list(12)
      logical first
      data first/.true./
